...
```
/goal night/007-absolute-load-store ブランチで実装し、 nightly CI 緑、 PR が auto-merge 設定済みで main に squash merge 完了、 nights/pending/007-absolute-load-store.md が nights/done/ に移動済み、 or stop after N turns
```
