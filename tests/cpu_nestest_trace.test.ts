...
// 夜 24: illegal SRE (7 opcode) を実装し 8454 行まで到達。
// 夜 25: illegal RRA (7 opcode) を実装し 8974 行まで到達。
// 夜 26: nestest 完走。8975-8991 行は完了ルーチン (結果チェック + APU ビープ)。
const TRACE_LINES = 8991;
