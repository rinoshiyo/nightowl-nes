...
function makeMinimalState(overrides?: Partial<NesState>): NesState {
  return {
    ...
    apu: {
      ...
      dmc: { timerPeriod: 428, timerValue: 0, outputLevel: 0, sampleBuffer: 0, sampleBufferEmpty: true, shiftRegister: 0, bitsRemaining: 1, silenceFlag: true, sampleAddress: 0xc000, sampleLength: 1, currentAddress: 0xc000, bytesRemaining: 0, loop: false, irqEnabled: false, irqFlag: false },
      frameMode: 0, frameCycle: 0, frameStep: 0, frameIrqInhibit: false, frameIrqFlag: false, cpuCycleOdd: false,
    },
    bus: { ram: [], dmaCycles: 0 },
    mapper: { id: 0, data: {} },
    ...overrides,
